...
-- Insert dữ liệu
INSERT INTO `fashionstore`.`user` (`id`, `login_Type`, `role`, `password`, `user_Name`, `avatar`, `email`, `phone_Number`) VALUES ('huynhnguyen', 'default', 'user', 'MQ==', 'Huỳnh Hoàng Khôi Nguyên', 'https://haycafe.vn/wp-content/uploads/2022/02/Avatar-trang-den.png', 'huynhnguyen1532@gmail.com', '0763002783');
INSERT INTO `fashionstore`.`user` (`id`, `login_Type`, `role`, `password`, `user_Name`, `avatar`, `email`, `phone_Number`) VALUES ('admin', 'default', 'admin', 'MQ==', 'Admin', 'https://haycafe.vn/wp-content/uploads/2022/02/Avatar-trang-den.png', 'admin@gmail.com', '0123456789');
-- user name = huynhnguyen pass=1
